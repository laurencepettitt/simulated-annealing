module Data.TSPLIB95 where

import Data.TSP ( CostFunc, Node )
import qualified Data.Map as M (Map, (!), fromList)
import qualified Data.List as L (stripPrefix)
import Data.Maybe ( catMaybes, isJust, listToMaybe )
import qualified Data.Text as T (unpack, strip, pack)
...
weight :: M.Map Int (Int, Int) -> (Node, Node) -> Integer
weight coords (a, b) =
    let coord = (coords M.!)
...
readTSP string =
    ...
    in
        (dim, fromIntegral . weight coords)
