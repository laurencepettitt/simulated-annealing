...
/* package simulated-annealing-0.1.0.0 */
#ifndef VERSION_simulated_annealing
#define VERSION_simulated_annealing "0.1.0.0"
#endif /* VERSION_simulated_annealing */
#ifndef MIN_VERSION_simulated_annealing
#define MIN_VERSION_simulated_annealing(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_simulated_annealing */
...
#define CURRENT_PACKAGE_KEY "simulated-annealing-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "simulated-annealing-0.1.0.0-inplace"
